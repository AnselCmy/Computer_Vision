...
{
    String imgs[] = {
                     "../img/erode/train/E1.png", "../img/erode/train/E2.png",
                     "../img/erode/train/E3.png", "../img/erode/train/E4.png",
                     "../img/erode/train/E5.png", "../img/erode/train/E6.png",
                     "../img/erode/train/E7.png",
                     "../img/erode/train/R1.png", "../img/erode/train/R2.png",
                     "../img/erode/train/R3.png", "../img/erode/train/R4.png",
                     "../img/erode/train/R5.png", "../img/erode/train/R6.png",
                    };
